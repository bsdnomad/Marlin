...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 30 }, { 190,  30 }, { 190, 190 }, { 30, 190 }, { X_CENTER, Y_CENTER } }
 ...
 */
  ...
  // #define PROBING_MARGIN_FRONT PROBING_MARGIN+20 // Before putting the bottom linear rails
